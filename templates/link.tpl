...
<ol>
    ...
    <li><a href="link.php?action=add">新增友谊链接</a></li>
    {if $update}
...
<form method="post" name="friendlink">
	...
	<table cellspacing="0" class="left">
        ...
        <tr id="logo" style="display:none"><td>Logo地址：<input type="text" class="text" name="logourl" /></td></tr>
        <tr><td>站 长 名：<input type="text" class="text" name="user" /></td></tr>
        <tr><td><input type="submit" class="submit" name="send" onclick="return checkLink();" value="申请友情链接" /></td></tr>
	</table>
</form>
{/if}
