...
<div id="feedback">
    ...
    <dl>
        ...
        <dd><em>{@value->date}发表</em><span>[{@value->user}]</span><img src="images/hot.png" alt="热" /></dd>
...
<div id="sidebar">
	<h2>热评文档总排行</h2>
    	<ul>
        {if $getHotTwentyComment}
    	{foreach $getHotTwentyComment(key,value)}
...
<div class="d5">
    ...
    <p class="red">请尊重互联网规则，不要发表关于政治、反动、色情之类的评论。</p>
    <p><textarea name="content"></textarea></p>
    <p style="position:relative;top:-5px;">
    	验证码：<input type="text" class="text" name="code" />
        <img src="confing/code.php" onclick="javascript:this.src='../confing/code.php?tm='+Math.random();" class="code"/>
