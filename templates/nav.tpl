...
<form method="post" name="add">
	...
	<table cellspacing="0" class="left">
		...
		<tr><td><input type="submit" name="send" value="新增导航" onclick="return checkForm()" class="submit nav" /> [ <a href="{$prev_url}">返回列表</a> ]</td></tr>
	</table>
</form>
{/if}
...
<form method="post" name="{$add}">
	...
	<table cellspacing="0" class="left">
		...
		<tr><td>导航名称：<input type="text" name="nav_name" class="text" />(*导航名称不得小于6位，不得大于20位！)</td></tr>
        <tr><td><textarea name="nav_info"></textarea>(*描述不得大于200位！)</td></tr>
		<tr><td><input type="submit" name="send" value="新增子导航" onclick="return checkForm()" class="submit nav" /> [ <a href="{$prev_url}">返回列表</a> ]</td></tr>
	</table>
</form>
{/if}
...
<form method="post" name="add">
	...
	<table cellspacing="0" class="left">
		<tr><td>导航名称：<input type="text" name="nav_name" value="{$nav_name}" class="text" />(*导航名称不得小于6位，不得大于20位！)</td></tr>
        <tr><td><textarea name="nav_info">{$nav_info}</textarea>(*描述不得大于200位！)</td></tr>
		<tr><td><input type="submit" name="send" value="修改导航" onclick="return checkForm()" class="submit nav" /> [ <a href="{$prev_url}">返回列表</a> ]</td></tr>
	</table>
</form>
{/if}
