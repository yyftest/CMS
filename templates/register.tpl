...
<div id="reg">
	...
	<form method="post" name="reg" action="?action=reg">
    	<dl>
            ...
            <dd>密 码 确 认：<input type="password" class="text" name="notpass" /><span class="red">[必填]</span>(*确认密码与密码保持一致）</dd>
            <dd>电 子 邮 件：<input type="text" class="text" name="email" /><span class="red">[必填]</span>(*每个电子邮件只能注册一个ID)</dd>
            <dd>选 择 头 像：<select name="face" onchange="sface();">
            ...
            <dd><img src="images/01.gif" name="faceImg" class="face" alt="01.gif" /></dd>
            <dd>安 全 问 题：
            ...
            <dd>问 题 答 案：<input type="text" class="text" name="answer" /></dd>
            <dd>验　证　码：<input type="text" class="text" name="code" /><span class="red">[必填]</span></dd>
            <dd><img src="confing/code.php" class="code" onclick="javascript:this.src='../confing/code.php?tm='+Math.random();"/></dd>
...
<div id="reg">
	...
	<form method="post" name="login" action="?action=login">
    	<dl>
            ...
            <dd>密　　　码：<input type="password" class="text" name="pass" /><span class="red">[必填]</span>(*密码不得小于6位)</dd>
            <dd>登录保留：
            			<input type="radio" name="time" checked="checked" value="0" />不保留
            ...
            <dd>验　证　码：<input type="text" class="text" name="code" /><span class="red">[必填]</span></dd>
            <dd><img src="confing/code.php" onclick="javascript:this.src='../confing/code.php?tm='+Math.random();"/></dd>
