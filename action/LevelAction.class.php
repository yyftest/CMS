  ...
  class LevelAction extends Action{
	  ...
	  private function add(){
		  if (isset($_POST['send'])) {
			  ...
			  $this->_model->addLevel() ? Tool::alertLocation('恭喜你，新等级成功！','level.php?action=show') : Tool::alertBack('很遗憾，新增等级失败！');
					  }
	  ...
	  private function delete(){
		  if (isset($_GET['id'])) {
						  ...
						  $this->_model->deleteLevel() ? Tool::alertLocation('恭喜你，删除管理员成功！', PREV_URL) : Tool::alertBack('很遗憾，删除等级失败！');
					  } else {
						  Tool::alertBack('非法操作！');
					  }
	  }
