...
<p>
	您好，<strong><?php echo $this->_vars['admin_user'];?></strong> [ <?php echo $this->_vars['level_name'];?> ] [ <a href="../" target="_blank">去首页</a> ] [ <a href="admin_login.php?action=logout" target="_parent">退出</a> ]
</p>
