...
<form name="login" id="adminLogin" method="post" action="admin_login.php?action=login">
	<fieldset>
		...
		<label><img src="../confing/code.php" onclick="javascript:this.src='../confing/code.php?tm='+Math.random();"/></label>
