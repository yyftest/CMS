...
<form method="post" name="add">
	<table cellspacing="0" class="left">
		<tr><td>等级名称：<input type="text" name="level_name" class="text" />(*等级名称不得小于6位，不得大于20位！)</td></tr>
...
<form method="post" name="add">
	...
	<table cellspacing="0" class="left">
		...
		<tr><td><input type="submit" name="send" value="修改等级" onclick="return checkForm()"  class="level" /> [ <a href="<?php echo $this->_vars['prev_url'];?>">返回列表</a> ]</td></tr>
	</table>
</form>
<?php } ?>
