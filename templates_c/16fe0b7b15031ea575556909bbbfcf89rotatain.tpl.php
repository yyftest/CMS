...
<ol>
    ...
    <li><a href="rotatain.php?action=add">新增管轮播器</a></li>
    <?php if(@$this->_vars['update']){ ?>
    <li><a href="rotatain.php?action=update&id=<?php echo $this->_vars['id'];?>">修改管轮播器</a></li>
    <?php } ?>
</ol>
...
<table cellspacing="0">
	...
	<?php }?>
    <tr><td colspan="5" style="color:orange;">( * 每当任何轮播器的操作或变动，都必须点击[生成xml文件]，来更新首页轮播器 )</td></tr>
...
<form method="post" name="content">
	<table cellspacing="0" class="left">
		<tr><td>轮 播 图：<input type="text" name="thumbnail" readonly="readonly" class="text" />
						 <input type="button" value="上传轮播图" onclick="centerWindow('../confing/upfile.php?type=rotatain','upfile','400','100')" />
