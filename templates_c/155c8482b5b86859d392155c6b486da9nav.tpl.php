...
<table cellspacing="0">
    ...
    <?php } ?>  
    <tr><td></td> <td></td> <td></td> <td></td> <td colspan="5"><input type="submit" name="send" value="排序" style="cursor:pointer" /></td></tr>
...
<form method="post" name="add">
	...
	<table cellspacing="0" class="left">
		<tr><td>导航名称：<input type="text" name="nav_name" class="text" />(*导航名称不得小于6位，不得大于20位！)</td></tr>
        <tr><td><textarea name="nav_info"></textarea>(*描述不得大于200位！)</td></tr>
		<tr><td><input type="submit" name="send" value="新增导航" onclick="return checkForm()" class="submit nav" /> [ <a href="<?php echo $this->_vars['prev_url'];?>">返回列表</a> ]</td></tr>
	</table>
</form>
<?php } ?>
...
<?php if(@$this->_vars['addchild']){ ?>
<form method="post" name="<?php echo $this->_vars['add'];?>">
    <input type="hidden" value="<?php echo $this->_vars['id'];?>" name="pid" />
	<table cellspacing="0" class="left">
        <tr><td>上级导航：<strong><?php echo $this->_vars['prev_name'];?></strong></td></tr>
		<tr><td>导航名称：<input type="text" name="nav_name" class="text" />(*导航名称不得小于6位，不得大于20位！)</td></tr>
        <tr><td><textarea name="nav_info"></textarea>(*描述不得大于200位！)</td></tr>
		<tr><td><input type="submit" name="send" value="新增子导航" onclick="return checkForm()" class="submit nav" /> [ <a href="<?php echo $this->_vars['prev_url'];?>">返回列表</a> ]</td></tr>
	</table>
</form>
<?php } ?>
...
<form method="post" name="add">
	...
	<table cellspacing="0" class="left">
		<tr><td>导航名称：<input type="text" name="nav_name" value="<?php echo $this->_vars['nav_name'];?>" class="text" />(*导航名称不得小于6位，不得大于20位！)</td></tr>
        <tr><td><textarea name="nav_info"><?php echo $this->_vars['nav_info'];?></textarea>(*描述不得大于200位！)</td></tr>
		<tr><td><input type="submit" name="send" value="修改导航" onclick="return checkForm()" class="submit nav" /> [ <a href="<?php echo $this->_vars['prev_url'];?>">返回列表</a> ]</td></tr>
	</table>
</form>
<?php } ?>
